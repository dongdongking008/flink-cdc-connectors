...
/**
 * The {@link com.alibaba.ververica.cdc.connectors.mongodb.MongoSourceFunction} is a streaming data source that pulls captured change data
 * from MongoDB into Flink.
 *
 ...
 */
@PublicEvolving
public class MongoSourceFunction<T> extends RichSourceFunction<T> implements
		CheckpointedFunction,
		ResultTypeQueryable<T> {

	private static final long serialVersionUID = -5808108641062931623L;

	protected static final Logger LOG = LoggerFactory.getLogger(com.alibaba.ververica.cdc.debezium.DebeziumSourceFunction.class);
	...
	public MongoSourceFunction(DebeziumDeserializationSchema<T> deserializer, Properties properties) {
